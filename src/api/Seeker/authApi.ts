...
export const authApi = createApi({
  ...
  endpoints: builder => ({
    ...
    guestLogin: builder.mutation<any, any>({
      query: credentials => ({
        url: SERVICE_API.AUTH.GUEST_LOGIN,
        method: HTTP_METHOD.POST,
        data: credentials,
      }),
      invalidatesTags: ['Auth'],
    ...
    verifyOTP: builder.mutation<any, any>({
      query: credentials => ({
        url: SERVICE_API.AUTH.VERIFY_OTP,
        method: HTTP_METHOD.POST,
        data: credentials,
      }),
      async onQueryStarted(_, {dispatch, queryFulfilled}) {
    ...
    resendOTP: builder.mutation<any, any>({
      query: credentials => ({
        url: SERVICE_API.AUTH.RESEND_OTP,
        method: HTTP_METHOD.POST,
        data: credentials,
      }),
      invalidatesTags: ['Auth'],
    ...
    resetPassword: builder.mutation<any, any>({
      query: credentials => ({
        url: SERVICE_API.AUTH.RESET_PASSWORD,
        method: HTTP_METHOD.POST,
        data: credentials,
      }),
      invalidatesTags: ['Auth'],
    ...
    forgotPassword: builder.mutation<any, any>({
      query: credentials => ({
        url: SERVICE_API.AUTH.FORGOT_PASSWORD,
        method: HTTP_METHOD.POST,
        data: credentials,
      }),
      invalidatesTags: ['Auth'],
    ...
    googleSignIn: builder.mutation<any, any>({
      query: credentials => ({
        url: SERVICE_API.AUTH.GOOGLE_SIGNIN,
        method: HTTP_METHOD.POST,
        data: credentials,
      }),
      invalidatesTags: ['Auth'],
    ...
    appleSignIn: builder.mutation<any, any>({
      query: credentials => ({
        url: SERVICE_API.AUTH.APPLE_SIGNIN,
        method: HTTP_METHOD.POST,
        data: credentials,
      }),
      invalidatesTags: ['Auth'],
